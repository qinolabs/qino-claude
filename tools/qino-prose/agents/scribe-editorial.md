...
You also read:
- `.claude/references/qino-scribe/voice.md` — the patterns to check against (line-level and chapter-level)
...
Read `.claude/references/qino-scribe/voice.md`. Check both line-level and chapter-level patterns.
...
- `.claude/references/qino-scribe/voice.md` — The unified patterns to check against (craft devices, line-level, chapter-level)
