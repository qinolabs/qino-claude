...
**Instead of** processing what happened ("The wanderer sat with what Selin had said"):
→ Aftermath, not reflection. They walk, they hold something, they notice a detail. The body moves; the mind doesn't narrate.

**Instead of** naming what was learned ("They understood now that the lenses showed relationship"):
→ Let it settle unnamed. The chapter showed it; the closing doesn't need to underline it.

**Instead of** description for its own sake ("The stars were bright, the air was cold, the stone was smooth"):
→ Presence, not rendering. One detail that lands, not inventory.

**Instead of** conclusions or meanings ("Something had shifted"):
→ Leave doors ajar. A sound they can't identify. A light in a window they hadn't noticed.
