...
Figures are a metaphor — in Bateson's sense, not the literary sense. In qino-world, a figure is a card with origin that carries mystery. In the chronicles, figures are characters like Seren and Lira who perceive the wanderer. In discovery-grid, figures might be marked threads that return. Same pattern — a persistent form that carries meaning through return — taking completely different shape in each context. You don't deduce your way to this recognition. You're deep in the scribe, refining how Seren sees the wanderer, and suddenly you recognize something about how figures should work in qino-world. The crab teaches you about the lobster. One context illuminates another through pattern, not logic.
