...
3. **Populate Setting Foundation** (required for image generation)
   ...
   See `references/chronicle/foundation.md` for field details.
...
- `references/chronicle/layers.md` — Lens-first architecture, checkpoints, prep.md structure
- `references/chronicle/story-lenses.md` — The twelve lenses, sensitivities, diff resonance
- `references/chronicle/disturbance.md` — How to read git diffs for shape and texture
- `references/chronicle/craft.md` — Chapter format, world.md structure, arc shapes
- `references/chronicle/voice.md` — Prose craft and patterns (used by prose and editorial agents)
- `references/chronicle/principles.md` — Relational principles embedded in layers
