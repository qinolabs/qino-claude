...
**Reference:** Read `references/concept/design-philosophy.md` — Part I for universal principles (especially sections 1-2).
...
If a path is provided, use it. If not, ask gently: "What would you like to bring in?"
...
("import [path]", "explore [concept]", "show me [concept]")
```
